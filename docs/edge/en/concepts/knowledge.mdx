...
Each knowledge level uses independent storage collections, and crew knowledge
is isolated by crew name (the same namespacing memory already uses):
...
# Named crew example: "research-crew__technical-specialist"
...
#   ├── Technical Specialist/                      # Agent knowledge (default crew)
#   └── research-crew__technical-specialist/       # Agent knowledge (named crew)
```
